...
public class SleeveDetection extends OpenCvPipeline {
    ...
    private static Point SLEEVE_TOPLEFT_ANCHOR_POINT = new Point(125, 100);
...
//            lower_yellow_bounds  = new Scalar(0, 200, 0, 255),
//            upper_yellow_bounds  = new Scalar(0, 255, 0, 255),
//            lower_cyan_bounds    = new Scalar(255, 174, 0, 255),
//            upper_cyan_bounds    = new Scalar(255, 87, 51, 255),
//            lower_magenta_bounds = new Scalar(0, 255, 230, 255),
//            upper_magenta_bounds = new Scalar(0, 255, 255, 255);
    private static final Scalar
...
//            lower_cyan_bounds    = new Scalar(0, 200, 200, 255),
            lower_cyan_bounds    = new Scalar(0, 150, 150, 255),
            upper_cyan_bounds    = new Scalar(150, 255, 255, 255),
            lower_magenta_bounds = new Scalar(130, 0, 130, 255),
    //      upper_magenta_bounds = new Scalar(255, 60, 255, 255);
            upper_magenta_bounds = new Scalar(255, 150, 255, 255);

    // Color definitions
    private final Scalar
//            YELLOW  = new Scalar(0, 255, 0),
//            CYAN    = new Scalar(255, 160, 0),
//            MAGENTA = new Scalar(0, 0, 255);
