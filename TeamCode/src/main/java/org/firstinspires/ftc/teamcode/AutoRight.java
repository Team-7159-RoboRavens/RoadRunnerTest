...
public class AutoRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Strafe left, rotate left 135 degrees
        // Grab cone (ground junction preset height)
        // Rotate 135 degrees right
        // Location 1: Strafe right, forward to location one
        // Rotate left 90 Degrees, place cone on mid junction
        // Location 2: Strafe right, forward to location 2
        // Rotate 45 degrees left, place cone on high junction
        // Location 3: invert location 2
        ...
        robot.rotate(Direction.RIGHT, 1, 180);
